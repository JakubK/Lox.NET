...
static int constantInformation(const char* name, Chunk* chunk, int offset) {
...
int disassembleInstruction(Chunk* chunk, int offset) {
    ...
    switch (instruction) {
        case OP_CONSTANT:
            return constantInformation("OP_CONSTANT", chunk, offset);
        case OP_NIL:
        ...
        case OP_GET_SUPER:
            return constantInformation("OP_GET_SUPER", chunk, offset);
